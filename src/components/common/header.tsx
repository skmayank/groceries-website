              ...
              <div className="row align-items-center">
                ...
                <div className="col-xl-3 col-lg-3 col-md-3 col-sm-3 ml-auto text-end col-12">
                  <div className="useraccount"> 
                    <div className="top-head-icon"><a><span className="number">{localStorageLikedData.length}</span><img alt="" className="w-35" src="images/heart.svg" /></a></div>
                    <a><img alt="" className="w-35" src="images/avatar-top.svg" /></a> 
                    <div className="top-head-icon" onClick={handleRedirection}><span className="number-blue">{localStorageCartData.length}</span><img alt="" className="w-35" src="images/cart.svg" /></div>
                  </div>
                </div>
              </div>
              {showFilter && 
